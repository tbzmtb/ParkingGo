...
/**
 * Created by tbzm on 16. 5. 19.
 */
public class ParkingLotHistoryInfoListViewAdapter extends BaseAdapter {
    ...
    public ParkingLotHistoryInfoListViewAdapter(Context context, ArrayList<ParkingInfoData> infoData) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.single_lot_history_info_row, null);
        ...
        holder.mLeftTitleText.setVisibility(View.GONE);
        holder.mRightTitleText.setVisibility(View.GONE);
